...
def signup():
    ...
    msg['Subject'] = 'OTP'
    msg['From'] = "lokeshakula222@gmail.com"
    msg['To'] = email
    
    
    s = smtplib.SMTP('smtp.gmail.com', 587)
    s.starttls()
    s.login("lokeshakula222@gmail.com", "gjzrzbghtbytedjr")
    s.send_message(msg)
    s.quit()
...
def predict():
    ...
    model = joblib.load('models/model_anova.sav')
...
def predict2():
    ...
    print(int_features,len(int_features))
    final4=[np.array(int_features)]
    model = joblib.load('models/model_mi.sav')
    predict = model.predict(final4)
